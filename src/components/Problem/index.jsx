  ...
  return (
      <div className="problem-wrap">
        <div className="container">
          ...
          {fields && <div className="row">
            <div name="oprobleme" className={`faq-term ${
              opened.includes(nazvanie) ? "opened" : ""
            }`}>
              ...
              <div className="faq-answer-opened description" dangerouslySetInnerHTML={{__html: text}}/>

              {gallery && <div className={`faq-answer`}>
                {gallery.map(img => (
...
const Problem = () => {
  ...
  return fields ? <ProblemView fields={fields.faq.oprobleme[0]} /> : <div>None</div>;
};
